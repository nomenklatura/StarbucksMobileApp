    ...
    public class CustomPickerRenderer : PickerRenderer
    {
        ...
        void BorderPicker(ElementChangedEventArgs<Picker> e, bool None = false)
        {
            if (e.NewElement != null)
            {
                ...
                ((CustomPicker)e.NewElement).PropertyChanging += OnPropertyChanging;
            ...
            {
                ((CustomPicker)e.OldElement).PropertyChanging -= OnPropertyChanging;
            }
        }
        ...
        void LinePicker(ElementChangedEventArgs<Picker> e)
        {
            try
            {
                ...
                if (e.NewElement is CustomPicker customPicker)
                {
                    Control.SetHighlightColor(color: customPicker.BorderColor.ToAndroid());
                    ...
                    for (int index = 0; index < fieldsNames.Length && index < drawablesNames.Length; index++)
                    {
                        ...
                        handleDrawable.SetColorFilter(new PorterDuffColorFilter(customPicker.BorderColor.ToAndroid(), PorterDuff.Mode.SrcIn));
                    ...
                    {
                        Control.BackgroundTintList = ColorStateList.ValueOf(customPicker.BorderColor.ToAndroid());
                    }
                    else
                    {
                        Control.Background.SetColorFilter(new PorterDuffColorFilter(customPicker.BorderColor.ToAndroid(), PorterDuff.Mode.SrcAtop));
                    }
        ...
        private void OnPropertyChanging(object sender, PropertyChangingEventArgs propertyChangingEventArgs)
        {
            ...
            {
                // incase if the focus was moved from another Picker
